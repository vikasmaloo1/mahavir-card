...
export default async function ProductPage({ params, searchParams }: PageProps<"/catalog/[slug]">) {
  ...
  return <main className="mc-storefront min-h-screen bg-[var(--mc-surface)] text-[var(--mc-ink)]">
    ...
    <div className="mx-auto max-w-[1440px] px-4 py-7 xl:px-8"><div className="flex flex-wrap items-center justify-between gap-3"><BackButton fallbackHref="/products" label="Back to products" /><p className="text-sm font-semibold text-[var(--mc-muted)]">{descriptor}</p></div>
