...
export async function POST(request: Request) {
  try {
    ...
    const initiated = await initiateArtworkUpload(session.user.id, { productId, pricingRuleId, replaceArtworkId, filename: file.name, contentType: file.type, fileSize: file.size, configuration });
