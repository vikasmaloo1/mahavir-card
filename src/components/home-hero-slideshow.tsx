...
const defaultHeroSlides: HeroSlide[] = [
  {
    ...
    imageAlt: "Premium printed stationery, luxury visiting cards with spot UV, folded brochure and pantone guide",
  ...
  },
  {
    ...
    subtitle:
      "High-definition CMYK brochures and pamphlets in A4 trifold and A8 pocket formats with sharp machine creasing and thermal lamination options.",
    primaryCtaLabel: "Configure Brochures",
    primaryCtaUrl: "/products?category=brochure",
    secondaryCtaLabel: "Flyers & Leaflets",
    secondaryCtaUrl: "/products?category=leaflet-cover",
    imageUrl: "/images/brochure-category.jpg",
    imageAlt: "Folded 250 GSM art card brochures with sharp creasing",
    floatingBadgeTitle: "250 GSM Specialists",
    floatingBadgeSubtitle: "A4 Trifold · A8 Pocket · Machine Creasing",
  ...
  },
  {
    ...
    subtitle:
      "Avery and standard vinyl adhesive stickers priced by finished square-inch area with automated margin checking and optional thermal lamination.",
    primaryCtaLabel: "Configure Stickers",
    primaryCtaUrl: "/products?category=sticker",
    secondaryCtaLabel: "Corporate Stationery",
    secondaryCtaUrl: "/products?category=letterhead-envelope",
    imageUrl: "/images/sticker-category.jpg",
    imageAlt: "Custom printed adhesive vinyl stickers and packaging product labels",
    floatingBadgeTitle: "Custom Stickers",
