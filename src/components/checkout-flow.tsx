      ...
      <div className="mx-auto max-w-md py-14 text-center">
        ...
        <form onSubmit={submitUtr} className="mt-5 text-left">
          <label className="block">
            ...
            <input required value={utr} onChange={(event) => setUtr(event.target.value)} placeholder="e.g. 402812345678" className="w-full rounded-lg border border-[var(--mc-line)] bg-white px-3.5 py-3 text-[15px] outline-none focus:border-[var(--mc-accent)] transition-colors" />
          </label>
