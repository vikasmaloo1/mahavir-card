...
function Section({ title, icon, children, className = "" }: { title: string; icon: React.ReactNode; children: React.ReactNode; className?: string }) { return <section className={`border border-[var(--mc-line)] bg-white p-5 ${className}`}><h2 className="flex items-center gap-2 font-bold">{icon}{title}</h2><div className="mt-3">{children}</div></section>; }
