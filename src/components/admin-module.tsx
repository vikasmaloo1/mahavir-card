...
const columns: Record<ModuleKey, { label: string; value: (row: Row) => string }[]> = {
  ...
  orders: [{ label: "Order", value: (r) => text(r.orderNumber) }, { label: "Customer", value: (r) => text(r.customerName) }, { label: "Type", value: (r) => text(r.customerType) }, { label: "Status", value: (r) => text(r.status) }, { label: "Total", value: (r) => formattedAmount(r.total) }, { label: "Created", value: (r) => formattedDate(r.createdAt) }],
