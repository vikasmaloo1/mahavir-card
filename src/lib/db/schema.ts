...
export const customers = pgTable(
  "customers",
  {
    ...
    creditEnabled: boolean("creditEnabled").notNull().default(true),
...
export const businessSettings = pgTable("business_settings", {
  ...
  gstNumber: text("gstNumber").default("24AIUPJ2271L1ZV"),
...
export const orders = pgTable(
  ...
  (table) => [
    ...
    index("orders_invoice_year_seq_idx").on(table.invoiceYear, table.invoiceSequence),
  ],
);
...
export const payments = pgTable("payments", {
  ...
  refundedAmount: numeric("refundedAmount", { precision: 12, scale: 2 }).notNull().default("0"),
...
export const walletTransactions = pgTable(
  "wallet_transactions",
  {
    ...
    balanceBefore: numeric("balanceBefore", { precision: 12, scale: 2 }),
