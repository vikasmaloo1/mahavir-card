...
const transitions = {
  order: {
    PENDING: ["CONFIRMED", "CANCELLED"], CONFIRMED: ["ARTWORK_REVIEW", "IN_PRODUCTION", "CANCELLED"], ARTWORK_REVIEW: ["ARTWORK_APPROVED", "CANCELLED"], ARTWORK_APPROVED: ["IN_PRODUCTION", "CANCELLED"], IN_PRODUCTION: ["QC", "CANCELLED"], QC: ["READY", "IN_PRODUCTION", "CANCELLED"], READY: ["DISPATCHED", "CANCELLED"], DISPATCHED: ["DELIVERED"], DELIVERED: [], CANCELLED: [],
  },
  quote: {
