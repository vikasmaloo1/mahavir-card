...
export const rateCatalog: RateCatalogCategory[] = [
  {
    ...
    items: [
      ...
      fixedCard("tearable-front-back-without-lamination", "Tearable Front Back Without Lamination Art Card 250 GSM", 300, "3-4 working days", visitingCardArtwork([slot("FRONT", "Front design"), slot("BACK", "Back design")]), { delivery: standardCourier, quoteable: false }),
      fixedCard("tearable-front-back-with-lamination", "Tearable Front Back With Lamination Art Card 250 GSM", 320, "4-5 working days", visitingCardArtwork([slot("FRONT", "Front design"), slot("BACK", "Back design")]), { delivery: standardCourier, quoteable: false }),
