...
export const rateCatalog: RateCatalogCategory[] = [
  ...
  },
  {
    ...
    items: [
      fixedCard("premium-400-gsm-velvet", "400 GSM Velvet", 746, "7-10 working days", premiumArtwork([slot("FRONT", "Front design"), slot("BACK", "Back design")]), { shortDescription: "400 GSM Velvet · Corner cut included by default." }),
      fixedCard("premium-400-gsm-velvet-single-side-uv", "400 GSM Velvet Single Side UV", 848, "7-10 working days", premiumArtwork([slot("FRONT", "Front design"), slot("BACK", "Back design"), slot("SPOT_UV", "Spot UV separation", "Black and white only")]), { shortDescription: "400 GSM Velvet Single Side UV · Corner cut included by default." }),
      fixedCard("premium-400-gsm-velvet-front-back-uv", "400 GSM Velvet Front Back UV", 932, "7-10 working days", premiumArtwork([slot("FRONT", "Front design"), slot("BACK", "Back design"), slot("FRONT_SPOT_UV", "Front Spot UV separation", "Black and white only"), slot("BACK_SPOT_UV", "Back Spot UV separation", "Black and white only")]), { shortDescription: "400 GSM Velvet Front Back UV · Corner cut included by default." }),
      fixedCard("premium-400-gsm-velvet-single-side-foil", "400 GSM Velvet With Single Side Foil", 1017, "7-10 working days", premiumArtwork([slot("FRONT", "Front design"), slot("BACK", "Back design"), slot("FOIL", "Foil separation", "Black and white only")]), { shortDescription: "400 GSM Velvet With Single Side Foil · Corner cut included by default." }),
      fixedCard("premium-400-gsm-velvet-front-back-foil", "400 GSM Velvet With Front Back Foil", 1288, "7-10 working days", premiumArtwork([slot("FRONT", "Front design"), slot("BACK", "Back design"), slot("FRONT_FOIL", "Front foil separation", "Black and white only"), slot("BACK_FOIL", "Back foil separation", "Black and white only")]), { shortDescription: "400 GSM Velvet With Front Back Foil · Corner cut included by default." }),
      fixedCard("premium-400-gsm-dripoff-front-back", "400 GSM Drip-Off Front Back", 1102, "7-10 working days", premiumArtwork([slot("FRONT", "Front design"), slot("BACK", "Back design"), slot("FRONT_DRIPOFF", "Front drip-off separation", "Black and white only"), slot("BACK_DRIPOFF", "Back drip-off separation", "Black and white only")]), { shortDescription: "400 GSM Drip-Off Front Back · Corner cut included by default." }),
    ].map((item) => ({ ...item, delivery: premiumCourier })),
  },
  {
    slug: "art-card", name: "Art Card", description: "Art card jobs priced by finished square-inch area.",
    items: [
      { slug: "art-card-single-side", name: "Art Card", shortDescription: "Square-inch pricing · single side", ruleType: "PER_SQ_INCH", ratePerSqInch: 28, rateUnit: "RUPEES", productionTime: "3-4 working days", referenceQuantity: 500, taxRate: 18, artwork: artCardArtwork([slot("FRONT", "Front design", "Recommended Black Color Ratio: C-50, M-20, Y-20, K-100 for achieving a rich, premium black in print")]) },
      { slug: "art-card-both-side", name: "Art Card Both Side", shortDescription: "Square-inch pricing · both sides · minimum 50 sq in", ruleType: "PER_SQ_INCH", ratePerSqInch: 33, rateUnit: "RUPEES", minimumArea: 50, productionTime: "3-4 working days", referenceQuantity: 500, taxRate: 18, artwork: artCardArtwork([slot("FRONT", "Front design", "THIS JOB BIG SIZE ONLY (MINIMUM SQ. INCH 50). Recommended Black Color Ratio: C-50, M-20, Y-20, K-100 for achieving a rich, premium black in print"), slot("BACK", "Back design", "THIS JOB BIG SIZE ONLY (MINIMUM SQ. INCH 50). Recommended Black Color Ratio: C-50, M-20, Y-20, K-100 for achieving a rich, premium black in print")]) },
      { slug: "art-card-both-side-lamination", name: "Art Card Both Side Lamination", shortDescription: "Square-inch pricing · both sides · lamination", ruleType: "PER_SQ_INCH", ratePerSqInch: 37, rateUnit: "RUPEES", productionTime: "3-4 working days", referenceQuantity: 1000, taxRate: 18, artwork: artCardArtwork([slot("FRONT", "Front design", "Recommended Black Color Ratio: C-50, M-20, Y-20, K-100 for achieving a rich, premium black in print"), slot("BACK", "Back design", "Recommended Black Color Ratio: C-50, M-20, Y-20, K-100 for achieving a rich, premium black in print")]) },
    ],
  },
  {
