...
export const openApiDocument = {
  ...
  paths: {
    ...
    "/api/products": { get: { ...operation("List active products with server-derived starting prices", "Public; query: q, category, orderable, quoteable. Pricing fields are derived from active customer-visible base rules."), tags: ["Catalog"] }, post: { ...operation("Create product", "ADMIN", body("ProductInput")), tags: ["Admin"] } },
  ...
  components: {
    ...
    schemas: {
      ...
      ArtworkInput: { type: "object", required: ["fileName", "fileType", "fileSize", "productId"], properties: { fileName: { type: "string", example: "business-card.pdf" }, fileType: { type: "string", enum: ["application/pdf", "application/octet-stream", "application/x-coreldraw"] }, fileSize: { type: "integer", minimum: 1 }, productId: { type: "string", format: "uuid" }, pricingRuleId: { type: ["string", "null"], format: "uuid" } } },
      ArtworkRequirement: {
        type: "object",
