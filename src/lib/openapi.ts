...
export const openApiDocument = {
  ...
  paths: {
    ...
    "/api/artworks/upload-url": { post: { ...operation("Authorize a private CDR upload and return a short-lived R2 PUT URL", "Authenticated CUSTOMER", body("ArtworkInput")), tags: ["Customer"] } },
    ...
    "/api/artworks/{id}/download": { get: { ...operation("Create a short-lived private CDR download", "Authenticated CUSTOMER owns artwork; ADMIN allowed; path: id"), tags: ["Customer"], parameters: [{ $ref: "#/components/parameters/Id" }] } },
